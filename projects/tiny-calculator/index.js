...
var theActiveMenu = document.querySelector("#aboutmenu");
theActiveMenu.setAttribute("status", "on");
var theActiveMobileMenu = document.querySelector("#mobilecontent2");
...
//email buttons
let emailButton = document.querySelector(".emailwritingbutton");
emailButton.addEventListener("click", function () {
  window.location.href = "mailto:akm.ayan7001@gmail.com";
});
